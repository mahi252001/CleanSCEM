    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new AlertDialog.Builder(maps.this)
                        ...
                        .setPositiveButton("Yes", (dialog, which) -> {
                            databaseReference = FirebaseDatabase.getInstance().getReference().child(Verify.name).child(key);
                            databaseReference.removeValue();
                            storageReference.child(image).delete();
                            storageReference.child(image).getDownloadUrl().addOnSuccessListener(uri -> storageReference.child(uri.toString()).delete());
                            Intent intent = new Intent(maps.this, Home.class);
        ...
        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            ...
            public void onFailure(@NonNull Exception e) {
                showUI();
                Toast.makeText(maps.this, "Error getting image", Toast.LENGTH_SHORT).show();
            }
        });
